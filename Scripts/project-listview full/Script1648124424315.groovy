...
WebUI.click(findTestObject('challenge/private challenge'))
...
WebUI.click(findTestObject('IMobj/member Suggestion 1'))

WebUI.setText(findTestObject('IMobj/members'), findTestData('Challnege Data').getValue(11, 1))

WebUI.click(findTestObject('IMobj/member Suggestion 2'))
...
WebUI.click(findTestObject('IMobj/Resolution list name'))
...
WebUI.click(findTestObject('ListView card/summary click'))
...
WebUI.click(findTestObject('ListView card/task member click'))
...
WebUI.click(findTestObject('ListView card/priority click'))
...
WebUI.click(findTestObject('ListView card/clear'))
